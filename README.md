...
5. An asynchronous task has been set up that will update the data in the database every 24 hours at 00:00 utc time. This ensures that you pick up any changes that the data 
